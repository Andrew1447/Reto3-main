...
<div class="botones">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <h1 class="card-title">Crear nueva partida</h1>
      </div>
      ...
      <div class="form-container">
        <form id="crear-partida-form">
          <div class="form-group">
            ...
            <input type="text" id="nombre" placeholder="Introduce un nombre para la partida">
          </div>
          
          <div class="form-group">
            <label for="numJugadores">Número de jugadores: <span id="jugadores-valor">4</span></label>
            <div class="slider-container">
              <input type="range" id="numJugadores" class="slider" min="2" max="200" value="4">
            </div>
            <div class="slider-value">
              ...
              <span id="jugadores-valor-icon">4</span>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea id="descripcion" placeholder="Añade detalles adicionales sobre la partida"></textarea>
          </div>
          
          <div class="submit-container">
            <button type="submit" class="submit-button">Crear partida</button>
          </div>
        </form>
      </div>
