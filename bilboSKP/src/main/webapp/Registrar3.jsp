...
<div class="botones">
          ...
          Volver al menu
                ...
                <div class="subscription-highlight">
                    ...
                    <ul class="plan-features">
                        <li>Opción de compra de tickets de juego</li>
                ...
                <div class="progress-bar">
                    ...
                    <div class="progress-labels">
                        ...
                        <span class="active">Método de pago</span>
                    </div>
                </div>
                    ...
                    <div class="step-content hidden" id="step2">
                        ...
                        <div class="payment-tabs">
                            <div class="tab-header">
                                <button class="tab-btn active" onclick="showTab('card')">Tarjeta de crédito</button>
                        ...
                        <div class="form-actions">
                            <button type="button" class="btn secondary" onclick="showStep(1)">Atrás</button>
                            <button type="submit" class="btn primary">Completar suscripción</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        function showStep(stepNumber) {
            ...
            if (stepNumber === 2) {
                ...
                if (nombre === '' || email === '' || password === '' || confirmPassword === '') {
                    ...
                    return; // No avanzar al siguiente paso si hay campos vacíos
                }

                if (password !== confirmPassword) {
                    alert('Las contraseñas no coinciden.');
                    return; // No avanzar si las contraseñas no coinciden
                }
            }
        ...
        // La función submitForm ya no es necesaria con el formulario unificado
        // function submitForm() {
        //     // Validación para el Paso 2 (Método de pago - Tarjeta de crédito)
        ...
        //     if (!cardTab.classList.contains('hidden')) { // Solo validar si la pestaña de tarjeta está visible
        //         if (cardName === '' || cardNumber === '' || expiry === '' || cvc === '') {
        //             alert('Por favor, completa todos los campos de la tarjeta de crédito.');
        //             return; // No mostrar el mensaje de éxito si faltan campos
        //         }
        //         // Aquí podrías añadir más validaciones para el formato de la tarjeta, fecha, etc.
        //     }

        //     // Si llegamos aquí, significa que los campos requeridos (en el paso visible) están llenos
        //     alert('¡Suscripción completada con éxito!');
        //     // Aquí podrías añadir la lógica para enviar los datos del formulario al servidor
        // }
