        ...
        <section class="help-section">
            ...
            <div class="faq-container">
                <div class="faq-item">
                    ...
                    <div class="faq-answer">Para reservar una sala de escape online, simplemente navega a la sección "Jugar" en nuestro sitio web, selecciona la sala que te interese y teniendo saldo de cupones podrá acceder a nuestra salas de escape virtuales.</div>
                </div>
                
                <div class="faq-item">
                    <div class="faq-question">¿Cuántas personas pueden participar en una sala virtual?</div>
                    <div class="faq-answer">El número de participantes varía según la sala, pero generalmente nuestras salas virtuales están diseñadas para equipos de 2 a 6 jugadores.</div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">¡Sí! Todas nuestras salas de escape virtuales incluyen un sistema de pistas. Si se queda atascado, pueden solicitar pistas.</div>
                </div>
            </div>
        </section>
    </main>
