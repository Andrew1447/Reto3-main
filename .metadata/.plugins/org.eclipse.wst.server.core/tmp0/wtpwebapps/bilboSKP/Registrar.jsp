...
<head>
    ...
    <link rel="stylesheet" href="styles/Resgistrarmenu.css">
...
<div class="botones">
    ...
    <div class="content-container">
        <div class="card">
            <h2>Registro</h2>
            <button class="casino-btn" onclick="window.location.href='SolicitudEmail.jsp'">SOY CENTRO</button>
            
            <button class="usuario-btn" onclick="window.location.href='Registrar3.jsp'">SOY USUARIO</button>
        </div>
    </div>
    <footer>
        <div class="container">
