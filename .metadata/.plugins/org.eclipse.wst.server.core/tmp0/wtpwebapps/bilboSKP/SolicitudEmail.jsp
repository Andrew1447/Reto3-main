          ...
          Volver al menu
			...
			<div class="content">
              ...
              <line x1="3" y1="10" x2="21" y2="10"></line>
					...
					<div class="section-content">
						<p>Para solicitar el registro de tu centro educativo en
							BilboSKP, debes enviar un correo electrónico con la información
						...
						<div class="steps">
							<div class="step">
								...
								<div class="step-content">
									<strong>Dirección de correo:</strong> Envía tu solicitud a <strong>centros@bilboskp.com</strong>
								</div>
							</div>
							<div class="step">
							...
							<div class="step">
								...
								<div class="step-content">
									...
									información requerida según la plantilla que te proporcionamos
									a continuación.
								</div>
							</div>
							<div class="step">
								...
								<div class="step-content">
									<strong>Espera la confirmación:</strong> Nuestro equipo
									revisará tu solicitud y te responderá en un plazo máximo de 48
									horas laborables.
								</div>
							</div>
						</div>
              ...
              <polyline points="10 9 9 9 8 9"></polyline>
					...
					<div class="section-content">
						<p>Utiliza la siguiente plantilla para redactar tu correo
							electrónico de solicitud. Asegúrate de incluir toda la
						...
						<div class="template">
							...
							plataforma. A continuación, les proporciono la información
							requerida: <span class="template-field">INFORMACIÓN DEL
								CENTRO:</span> - Nombre del centro: <span class="template-field">[Nombre
								completo del centro educativo]</span> - Ubicación del centro: <span
								class="template-field">[Dirección completa, incluyendo
								ciudad y código postal]</span> - Número de alumnos: <span
								class="template-field">[Número total de alumnos
								matriculados]</span> <span class="template-field">INFORMACIÓN
							...
							ocupa en el centro: <span class="template-field">[Tu cargo
								o función en el centro educativo]</span> - Correo electrónico de
							contacto: <span class="template-field">[Tu correo
								electrónico profesional]</span> - Teléfono de contacto: <span
								class="template-field">[Tu número de teléfono]</span> Quedo a la
							espera de su respuesta y disponible para proporcionar cualquier
							información adicional que puedan necesitar. Atentamente, <span
                  ...
                  <line x1="12" y1="8" x2="12.01" y2="8"></line>
							...
							<p>Todos los campos marcados en azul son obligatorios. La
								solicitud no podrá ser procesada si falta alguno de estos datos.
								Asegúrate de utilizar un correo electrónico institucional para
              ...
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
					...
					<div class="section-content">
						<p>Una vez recibida tu solicitud, nuestro equipo verificará la
							información proporcionada. Es posible que nos pongamos en
							contacto contigo para solicitar documentación adicional que
							acredite la existencia del centro educativo.</p>
						<p>Tras la verificación, recibirás un correo electrónico con
							las credenciales de acceso a la plataforma y las instrucciones
							para completar la configuración de tu cuenta de centro.</p>
					</div>
				</div>
