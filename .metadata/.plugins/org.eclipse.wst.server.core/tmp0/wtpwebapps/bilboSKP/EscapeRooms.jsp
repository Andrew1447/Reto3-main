...
<div class="botones">
			...
			<div class="room-card">
				<div class="room-image">
					<div class="video-container">
						<a href="#">
							<div class="placeholder-image"></div> <video id="miVideo"
								controls muted height="200px" width="200px">
								<source src="img/gaztek.mkv" type="video/mp4">
							</video>
						</a>
					</div>
				</div>
				<h3 class="room-title">Gaztek</h3>
				<a href="#" class="enlace-btn">Jugar</a>
			</div>

			<div class="room-card">
				<div class="room-image">
					<img src="img/Gemini1.jpg" height="300px" width="300px">
				</div>
				<h3 class="room-title">La Maldició Del Farraön</h3>
				<a href="#" class="enlace-btn">Jugar</a>
			</div>
			<div class="room-card">
				<div class="room-image">
					<img src="img/Gemini2.jpg" height="300px" width="300px">
				</div>
				<h3 class="room-title">The Ciphered Sanctum</h3>
				<a href="#" class="enlace-btn">Jugar</a>
			</div>

			<div class="room-card">
				<div class="room-image">
					<img src="img/Gemini4.jpg" height="300px" width="300px">
				</div>
				<h3 class="room-title">The Last Hour</h3>
				<a href="#" class="enlace-btn">Jugar</a>
			</div>
			<div class="room-card">
				<div class="room-image">
					<img src="img/Gemini5.jpg" height="300px" width="300px">
				</div>
				<h3 class="room-title">Echoes Of The Past</h3>
				<a href="#" class="enlace-btn">Jugar</a>
			</div>

			<div class="room-card">
				<div class="room-image">
					<img src="img/Gemini10.jpg" height="300px" width="300px">
				</div>
				<h3 class="room-title">Escape The Matrix</h3>
				<a href="#" class="enlace-btn">Jugar</a>
			</div>
		</div>
	</div>
	...
	<script>
        // Este script es opcional, pero es una buena práctica
        // asegurarse de que el video se detenga cuando el ratón
        // deja de estar encima.
