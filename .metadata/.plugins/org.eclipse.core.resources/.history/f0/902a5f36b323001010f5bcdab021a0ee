...
public class RegisterUsuarioController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // 2. Insertar la suscripción ligada al nombre del usuario
            ...
            // 3. Actualizar el usuario con el id de la suscripción
            ...
            preparedStatementUpdateUsuario.setString(2, nombre); // AQUI también usar nombre directamente

            int filasUpdateUsuario = preparedStatementUpdateUsuario.executeUpdate();

            if (filasUpdateUsuario == 0) {
                throw new SQLException("Error al actualizar el usuario con el ID de la suscripción.");
            }
